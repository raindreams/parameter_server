...
void protobuf_AssignDesc_proto_2fmatrix_2eproto() {
  protobuf_AddDesc_proto_2fmatrix_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "proto/matrix.proto");
  GOOGLE_CHECK(file != NULL);
  MatrixInfo_descriptor_ = file->message_type(0);
  static const int MatrixInfo_offsets_[10] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MatrixInfo, nnz_per_row_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MatrixInfo, nnz_per_col_),
  };
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_proto_2fmatrix_2eproto);
}
...
void protobuf_AddDesc_proto_2fmatrix_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\022proto/matrix.proto\022\002PS\032\021proto/range.pr"
    "oto\"\227\002\n\nMatrixInfo\022!\n\004type\030\001 \002(\0162\023.PS.Ma"
    "trixInfo.Type\022\021\n\trow_major\030\002 \002(\010\022\n\n\002id\030\003"
    " \001(\005\022\030\n\003row\030\005 \002(\0132\013.PS.PbRange\022\030\n\003col\030\006 "
    "\002(\0132\013.PS.PbRange\022\013\n\003nnz\030\007 \001(\004\022\024\n\014sizeof_"
    "index\030\010 \001(\r\022\024\n\014sizeof_value\030\t \002(\r\022\023\n\013nnz"
    "_per_row\030\013 \001(\002\022\023\n\013nnz_per_col\030\014 \001(\002\"0\n\004T"
    "ype\022\t\n\005DENSE\020\001\022\n\n\006SPARSE\020\002\022\021\n\rSPARSE_BIN"
    "ARY\020\003", 325);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "proto/matrix.proto", &protobuf_RegisterTypes);
  MatrixInfo::default_instance_ = new MatrixInfo();
  MatrixInfo::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_proto_2fmatrix_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_proto_2fmatrix_2eproto {
  StaticDescriptorInitializer_proto_2fmatrix_2eproto() {
    protobuf_AddDesc_proto_2fmatrix_2eproto();
  }
} static_descriptor_initializer_proto_2fmatrix_2eproto_;
...
const int MatrixInfo::kNnzPerRowFieldNumber;
const int MatrixInfo::kNnzPerColFieldNumber;
#endif  // !_MSC_VER
...
const MatrixInfo& MatrixInfo::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_proto_2fmatrix_2eproto();
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 9: {
        ...
        if (input->ExpectTag(93)) goto parse_nnz_per_row;
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(101)) goto parse_nnz_per_col;
        break;
      }
...
void MatrixInfo::SerializeWithCachedSizes(
  ...
  // optional float nnz_per_row = 11;
  if (has_nnz_per_row()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(11, this->nnz_per_row(), output);
  }

  // optional float nnz_per_col = 12;
  if (has_nnz_per_col()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(12, this->nnz_per_col(), output);
  }
...
::google::protobuf::uint8* MatrixInfo::SerializeWithCachedSizesToArray(
  ...
  // optional float nnz_per_row = 11;
  if (has_nnz_per_row()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(11, this->nnz_per_row(), target);
  }

  // optional float nnz_per_col = 12;
  if (has_nnz_per_col()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(12, this->nnz_per_col(), target);
  }
...
void MatrixInfo::MergeFrom(const MatrixInfo& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    if (from.has_nnz_per_row()) {
      set_nnz_per_row(from.nnz_per_row());
    }
    if (from.has_nnz_per_col()) {
      set_nnz_per_col(from.nnz_per_col());
    }
  }
...
void MatrixInfo::Swap(MatrixInfo* other) {
  if (other != this) {
    ...
    std::swap(nnz_per_row_, other->nnz_per_row_);
    std::swap(nnz_per_col_, other->nnz_per_col_);
